...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Layer.params'
        db.delete_column('lizard_workspace_layer', 'params')

        # Deleting field 'Layer.wms'
        db.delete_column('lizard_workspace_layer', 'wms')

        # Adding field 'Layer.use_location_filter'
        db.add_column('lizard_workspace_layer', 'use_location_filter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Layer.location_filter'
        db.add_column('lizard_workspace_layer', 'location_filter', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Layer.ollayer_class'
        db.add_column('lizard_workspace_layer', 'ollayer_class', self.gf('django.db.models.fields.CharField')(default='OpenLayers.layer.WMS', max_length=80), keep_default=False)
        ...
        # Adding field 'Layer.layers'
        db.add_column('lizard_workspace_layer', 'layers', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'Layer.filter'
        db.add_column('lizard_workspace_layer', 'filter', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'Layer.request_params'
        db.add_column('lizard_workspace_layer', 'request_params', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Layer.is_base_layer'
        db.add_column('lizard_workspace_layer', 'is_base_layer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Layer.single_tile'
        db.add_column('lizard_workspace_layer', 'single_tile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Layer.params'
        db.add_column('lizard_workspace_layer', 'params', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Layer.wms'
        db.add_column('lizard_workspace_layer', 'wms', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)

        # Deleting field 'Layer.use_location_filter'
        db.delete_column('lizard_workspace_layer', 'use_location_filter')

        # Deleting field 'Layer.location_filter'
        db.delete_column('lizard_workspace_layer', 'location_filter')

        # Deleting field 'Layer.ollayer_class'
        db.delete_column('lizard_workspace_layer', 'ollayer_class')

        # Deleting field 'Layer.url'
        db.delete_column('lizard_workspace_layer', 'url')

        # Deleting field 'Layer.layers'
        db.delete_column('lizard_workspace_layer', 'layers')

        # Deleting field 'Layer.filter'
        db.delete_column('lizard_workspace_layer', 'filter')

        # Deleting field 'Layer.request_params'
        db.delete_column('lizard_workspace_layer', 'request_params')

        # Deleting field 'Layer.is_base_layer'
        db.delete_column('lizard_workspace_layer', 'is_base_layer')

        # Deleting field 'Layer.single_tile'
        db.delete_column('lizard_workspace_layer', 'single_tile')
    ...
    models = {
        ...
        'lizard_workspace.layer': {
            ...
            'group_code': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
