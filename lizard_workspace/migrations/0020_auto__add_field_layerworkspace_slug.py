...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerWorkspace.slug'
        db.add_column('lizard_workspace_layerworkspace', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerWorkspace.slug'
        db.delete_column('lizard_workspace_layerworkspace', 'slug')
