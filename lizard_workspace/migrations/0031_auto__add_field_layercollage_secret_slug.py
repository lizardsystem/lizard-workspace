...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollage.secret_slug'
        db.add_column('lizard_workspace_layercollage', 'secret_slug', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollage.secret_slug'
        db.delete_column('lizard_workspace_layercollage', 'secret_slug')
