...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_workspace_layerworkspaceitem', (
            ...
            ('filter_string', self.gf('django.db.models.fields.CharField')(max_length=124, null=True, blank=True)),
            ...
            ('opacity', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
