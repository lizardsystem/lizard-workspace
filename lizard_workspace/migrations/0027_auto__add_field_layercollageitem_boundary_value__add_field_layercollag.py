...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollageItem.boundary_value'
        db.add_column('lizard_workspace_layercollageitem', 'boundary_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LayerCollageItem.percentile_value'
        db.add_column('lizard_workspace_layercollageitem', 'percentile_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LayerCollageItem.summer_or_winter'
        ...
        # Adding field 'LayerCollageItem.restrict_to_month'
        ...
        # Adding field 'LayerCollageItem.day_of_week'
        ...
        # Adding field 'LayerCollageItem.day_or_night'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LayerCollageItem.boundary_value'
        db.delete_column('lizard_workspace_layercollageitem', 'boundary_value')

        # Deleting field 'LayerCollageItem.percentile_value'
        db.delete_column('lizard_workspace_layercollageitem', 'percentile_value')

        # Deleting field 'LayerCollageItem.summer_or_winter'
        db.delete_column('lizard_workspace_layercollageitem', 'summer_or_winter')

        # Deleting field 'LayerCollageItem.restrict_to_month'
        db.delete_column('lizard_workspace_layercollageitem', 'restrict_to_month')

        # Deleting field 'LayerCollageItem.day_of_week'
        db.delete_column('lizard_workspace_layercollageitem', 'day_of_week')

        # Deleting field 'LayerCollageItem.day_or_night'
        db.delete_column('lizard_workspace_layercollageitem', 'day_or_night')
    ...
    models = {
        ...
        'lizard_workspace.layercollageitem': {
            ...
            'day_or_night': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            ...
            'summer_or_winter': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
