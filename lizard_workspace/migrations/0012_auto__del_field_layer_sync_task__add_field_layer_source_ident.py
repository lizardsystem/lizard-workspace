...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Layer.sync_task'
        db.delete_column('lizard_workspace_layer', 'sync_task_id')

        # Adding field 'Layer.source_ident'
        db.add_column('lizard_workspace_layer', 'source_ident', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Layer.sync_task'
        db.add_column('lizard_workspace_layer', 'sync_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.SyncTask'], null=True, blank=True), keep_default=False)

        # Deleting field 'Layer.source_ident'
        db.delete_column('lizard_workspace_layer', 'source_ident')
