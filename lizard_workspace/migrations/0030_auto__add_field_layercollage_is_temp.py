...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollage.is_temp'
        db.add_column('lizard_workspace_layercollage', 'is_temp', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollage.is_temp'
        db.delete_column('lizard_workspace_layercollage', 'is_temp')
