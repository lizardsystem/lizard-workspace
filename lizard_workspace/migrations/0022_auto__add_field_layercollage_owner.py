...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollage.owner'
        db.add_column('lizard_workspace_layercollage', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollage.owner'
        db.delete_column('lizard_workspace_layercollage', 'owner_id')
