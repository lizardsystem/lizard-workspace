...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollage.timestamp_updated'
        db.add_column('lizard_workspace_layercollage', 'timestamp_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 6, 21, 13, 50, 59, 161628), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollage.timestamp_updated'
        db.delete_column('lizard_workspace_layercollage', 'timestamp_updated')
    ...
    models = {
        ...
        'lizard_workspace.layercollage': {
            ...
            'timestamp_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
