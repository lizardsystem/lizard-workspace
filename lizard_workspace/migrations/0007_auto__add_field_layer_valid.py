...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layer.valid'
        db.add_column('lizard_workspace_layer', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layer.valid'
        db.delete_column('lizard_workspace_layer', 'valid')
