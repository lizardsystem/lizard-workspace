...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncTask.tag'
        db.add_column('lizard_workspace_synctask', 'tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.Tag'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyncTask.tag'
        db.delete_column('lizard_workspace_synctask', 'tag_id')
