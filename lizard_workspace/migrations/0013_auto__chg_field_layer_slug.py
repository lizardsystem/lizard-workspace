...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layer.slug'
        db.alter_column('lizard_workspace_layer', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Layer.slug'
        db.alter_column('lizard_workspace_layer', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
