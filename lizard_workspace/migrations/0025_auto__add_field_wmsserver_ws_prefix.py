...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WmsServer.ws_prefix'
        db.add_column('lizard_workspace_wmsserver', 'ws_prefix', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WmsServer.ws_prefix'
        db.delete_column('lizard_workspace_wmsserver', 'ws_prefix')
