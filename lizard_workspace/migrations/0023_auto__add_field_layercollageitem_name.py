...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollageItem.name'
        db.add_column('lizard_workspace_layercollageitem', 'name', self.gf('django.db.models.fields.CharField')(default='Name', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollageItem.name'
        db.delete_column('lizard_workspace_layercollageitem', 'name')
