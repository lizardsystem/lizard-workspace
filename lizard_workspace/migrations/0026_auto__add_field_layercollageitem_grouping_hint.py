...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollageItem.grouping_hint'
        db.add_column('lizard_workspace_layercollageitem', 'grouping_hint', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollageItem.grouping_hint'
        db.delete_column('lizard_workspace_layercollageitem', 'grouping_hint')
