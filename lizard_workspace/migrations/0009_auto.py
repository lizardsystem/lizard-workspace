...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field layer_tag on 'LayerFolder'
        db.create_table('lizard_workspace_layerfolder_layer_tag', (
        ...
        db.create_unique('lizard_workspace_layerfolder_layer_tag', ['layerfolder_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field layer_tag on 'LayerFolder'
        db.delete_table('lizard_workspace_layerfolder_layer_tag')
