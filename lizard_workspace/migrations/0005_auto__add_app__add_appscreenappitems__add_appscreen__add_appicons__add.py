...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'App'
        db.create_table('lizard_workspace_app', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('mouse_over', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('icon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.AppIcons'])),
            ('action_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('root_map', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.LayerFolder'], null=True, blank=True)),
            ('appScreen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.AppScreen'], null=True, blank=True)),
            ('action_params', self.gf('django.db.models.fields.TextField')(default='{}', blank=True)),
        ))
        db.send_create_signal('lizard_workspace', ['App'])

        # Adding model 'AppScreenAppItems'
        db.create_table('lizard_workspace_appscreenappitems', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('appscreen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.AppScreen'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.App'])),
            ('index', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal('lizard_workspace', ['AppScreenAppItems'])

        # Adding model 'AppScreen'
        db.create_table('lizard_workspace_appscreen', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal('lizard_workspace', ['AppScreen'])

        # Adding model 'AppIcons'
        db.create_table('lizard_workspace_appicons', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('lizard_workspace', ['AppIcons'])

        # Adding model 'LayerFolder'
        db.create_table('lizard_workspace_layerfolder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children_set', null=True, to=orm['lizard_workspace.LayerFolder'])),
        ))
        db.send_create_signal('lizard_workspace', ['LayerFolder'])

        # Adding M2M table for field layers on 'LayerFolder'
        db.create_table('lizard_workspace_layerfolder_layers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('layerfolder', models.ForeignKey(orm['lizard_workspace.layerfolder'], null=False)),
            ('layer', models.ForeignKey(orm['lizard_workspace.layer'], null=False))
        ))
        db.create_unique('lizard_workspace_layerfolder_layers', ['layerfolder_id', 'layer_id'])

        # Adding M2M table for field layer_tab on 'LayerFolder'
        db.create_table('lizard_workspace_layerfolder_layer_tab', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('layerfolder', models.ForeignKey(orm['lizard_workspace.layerfolder'], null=False)),
            ('tag', models.ForeignKey(orm['lizard_workspace.tag'], null=False))
        ))
        db.create_unique('lizard_workspace_layerfolder_layer_tab', ['layerfolder_id', 'tag_id'])

        # Adding field 'Layer.user'
        db.add_column('lizard_workspace_layer', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Layer.owner_type'
        db.add_column('lizard_workspace_layer', 'owner_type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'App'
        db.delete_table('lizard_workspace_app')

        # Deleting model 'AppScreenAppItems'
        db.delete_table('lizard_workspace_appscreenappitems')

        # Deleting model 'AppScreen'
        db.delete_table('lizard_workspace_appscreen')

        # Deleting model 'AppIcons'
        db.delete_table('lizard_workspace_appicons')

        # Deleting model 'LayerFolder'
        db.delete_table('lizard_workspace_layerfolder')

        # Removing M2M table for field layers on 'LayerFolder'
        db.delete_table('lizard_workspace_layerfolder_layers')

        # Removing M2M table for field layer_tab on 'LayerFolder'
        db.delete_table('lizard_workspace_layerfolder_layer_tab')

        # Deleting field 'Layer.user'
        db.delete_column('lizard_workspace_layer', 'user_id')

        # Deleting field 'Layer.owner_type'
        db.delete_column('lizard_workspace_layer', 'owner_type')
    ...
    models = {
        ...
        'lizard_workspace.app': {
            ...
            'appScreen': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_workspace.AppScreen']", 'null': 'True', 'blank': 'True'}),
        ...
        'lizard_workspace.appscreen': {
            ...
            'apps': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lizard_workspace.App']", 'through': "orm['lizard_workspace.AppScreenAppItems']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'})
        },
