...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layer.js_popup_class'
        db.add_column('lizard_workspace_layer', 'js_popup_class', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layer.js_popup_class'
        db.delete_column('lizard_workspace_layer', 'js_popup_class')
