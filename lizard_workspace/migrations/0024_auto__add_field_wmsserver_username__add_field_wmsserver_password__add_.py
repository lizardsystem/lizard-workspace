...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WmsServer.username'
        db.add_column('lizard_workspace_wmsserver', 'username', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'WmsServer.password'
        db.add_column('lizard_workspace_wmsserver', 'password', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'WmsServer.enable_proxy'
        db.add_column('lizard_workspace_wmsserver', 'enable_proxy', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WmsServer.username'
        db.delete_column('lizard_workspace_wmsserver', 'username')

        # Deleting field 'WmsServer.password'
        db.delete_column('lizard_workspace_wmsserver', 'password')

        # Deleting field 'WmsServer.enable_proxy'
        db.delete_column('lizard_workspace_wmsserver', 'enable_proxy')
    ...
    models = {
        ...
        'lizard_workspace.layercollageitem': {
            'Meta': {'object_name': 'LayerCollageItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
