...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerCollage.summer_or_winter'
        db.add_column('lizard_workspace_layercollage', 'summer_or_winter', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'LayerCollage.restrict_to_month'
        db.add_column('lizard_workspace_layercollage', 'restrict_to_month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'LayerCollage.day_of_week'
        db.add_column('lizard_workspace_layercollage', 'day_of_week', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'LayerCollage.day_or_night'
        db.add_column('lizard_workspace_layercollage', 'day_or_night', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerCollage.summer_or_winter'
        db.delete_column('lizard_workspace_layercollage', 'summer_or_winter')

        # Deleting field 'LayerCollage.restrict_to_month'
        db.delete_column('lizard_workspace_layercollage', 'restrict_to_month')

        # Deleting field 'LayerCollage.day_of_week'
        db.delete_column('lizard_workspace_layercollage', 'day_of_week')

        # Deleting field 'LayerCollage.day_or_night'
        db.delete_column('lizard_workspace_layercollage', 'day_or_night')
