...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LayerCollage'
        db.create_table('lizard_workspace_layercollage', (
            ...
            ('owner_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('personal_category', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
        ...
        db.send_create_signal('lizard_workspace', ['LayerCollage'])

        # Adding model 'LayerCollageItem'
        db.create_table('lizard_workspace_layercollageitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('layer_collage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.LayerCollage'])),
        ...
        db.send_create_signal('lizard_workspace', ['LayerCollageItem'])


    def backwards(self, orm):
        
        # Deleting model 'LayerCollage'
        db.delete_table('lizard_workspace_layercollage')

        # Deleting model 'LayerCollageItem'
        db.delete_table('lizard_workspace_layercollageitem')
