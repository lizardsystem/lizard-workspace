...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'App.appScreen'
        db.delete_column('lizard_workspace_app', 'appScreen_id')

        # Adding field 'App.appscreen'
        db.add_column('lizard_workspace_app', 'appscreen', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_workspace.AppScreen']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'App.appScreen'
        db.add_column('lizard_workspace_app', 'appScreen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_workspace.AppScreen'], null=True, blank=True), keep_default=False)
