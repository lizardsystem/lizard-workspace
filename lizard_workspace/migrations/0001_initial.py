...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ThematicMap'
        db.create_table('lizard_workspace_thematicmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('lizard_workspace', ['ThematicMap'])
        ...
        db.create_table('lizard_workspace_layerworkspace', (
            ('workspacestorage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lizard_map.WorkspaceStorage'], unique=True, primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ThematicMap'
        db.delete_table('lizard_workspace_thematicmap')
