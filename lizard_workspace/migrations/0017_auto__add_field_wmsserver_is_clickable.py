...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WmsServer.is_clickable'
        db.add_column('lizard_workspace_wmsserver', 'is_clickable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WmsServer.is_clickable'
        db.delete_column('lizard_workspace_wmsserver', 'is_clickable')
