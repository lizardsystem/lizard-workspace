...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layer.is_local_server'
        db.add_column('lizard_workspace_layer', 'is_local_server', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layer.is_local_server'
        db.delete_column('lizard_workspace_layer', 'is_local_server')
